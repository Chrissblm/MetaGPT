...
code_review = st.checkbox("Use code review?", key="startup_code_review")
run_tests = st.checkbox("Run tests?", key="startup_run_tests")
implement = st.checkbox("Implement?", key="startup_implement")
